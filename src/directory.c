...
/*   Updated: 2019/02/22 10:12:27 by bboutoil         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int collect_special_dots_if_required(DIR *dir, t_options *opt, t_flist *f_list, t_fstat *fs)
{
	struct dirent *d;
...
static int collect_files(DIR *dir, t_options *opt, t_flist *f_list)
{
	...
	if (collect_special_dots_if_required(dir, opt, f_list, &fs) == ALLOC_ERROR)
		return (ALLOC_ERROR);
